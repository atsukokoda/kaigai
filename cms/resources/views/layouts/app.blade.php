        ...
        <div style="padding-right:20px; position: absolute; text-align:right; bottom: 0;right: 0;">
          ...
          <ul style="list-style-type:none; display: flex; justify-content: space-between;">
            ...
            <ul style="list-style-type:none; display: flex; justify-content: space-between;">    
                    ...
                    <li style="padding-right:20px;">ログインする</li>
             </ul>     
            @endif 
        </div>    
    </div>
...
<footer style="font-size: 80%; width: 100%; text-align: center; padding-top: 10px; padding-bottom: 10px; background-color: #313131; margin-top:auto">

<div class="row">
  <div class="col-lg-12">
    <address style="color: #fff;letter-spacing: 5px;">Copyright(C)TohanKaigai,Allright Reserved.</address>
